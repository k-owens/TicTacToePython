...
class TestGameBoard(TestCase):
    ...
    def test_game_does_not_end_early2(self):
        _game_board = game_board.GameBoard([1, 2, 1, 0, 0, 0, 0, 0, 0])
        self.assertFalse(_game_board.is_game_over())

    def test_game_ends_with_full_board(self):
        _game_board = game_board.GameBoard([1, 2, 1, 2, 1, 2, 2, 1, 1])
        self.assertTrue(_game_board.is_game_over())

    def test_game_ends_with_horizontal_win(self):
        _game_board = game_board.GameBoard([1, 1, 1, 0, 0, 0, 0, 0, 0])
        _game_board2 = game_board.GameBoard([0, 0, 0, 2, 2, 2, 0, 0, 0])
        _game_board3 = game_board.GameBoard([0, 0, 0, 0, 0, 0, 1, 1, 1])
        self.assertTrue(_game_board.is_game_over())
    ...
    def test_game_ends_with_vertical_win(self):
        _game_board = game_board.GameBoard([1, 0, 0, 1, 0, 0, 1, 0, 0])
        _game_board2 = game_board.GameBoard([0, 2, 0, 0, 2, 0, 0, 2, 0])
        _game_board3 = game_board.GameBoard([0, 0, 1, 0, 0, 1, 0, 0, 1])
        self.assertTrue(_game_board.is_game_over())
        self.assertTrue(_game_board2.is_game_over())
        self.assertTrue(_game_board3.is_game_over())

    def test_game_ends_with_diagonal_win(self):
        _game_board = game_board.GameBoard([1, 0, 0, 0, 1, 0, 0, 0, 1])
        _game_board2 = game_board.GameBoard([0, 0, 2, 0, 2, 0, 2, 0, 0])
        self.assertTrue(_game_board.is_game_over())
        self.assertTrue(_game_board2.is_game_over())
